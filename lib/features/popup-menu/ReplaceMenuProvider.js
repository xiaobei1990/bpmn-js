...
ReplaceMenuProvider.prototype._getLoopCharacteristicsHeaderEntries = function(target) {
  ...
  function toggleLoopEntry(event, entry) {
    ...
    window.console.log(newLoopCharacteristics, entry, '4444')
  ...
  if (loopCharacteristics) {
    ...
    if (is(businessObject, 'bpmn:UserTask')) {
      var tempLoopCharacteristics = self._moddle.create('bpmn:MultiInstanceLoopCharacteristics');
      tempLoopCharacteristics.isSequential = false;
      self._modeling.updateProperties(target, { loopCharacteristics: tempLoopCharacteristics });
    }
  }
